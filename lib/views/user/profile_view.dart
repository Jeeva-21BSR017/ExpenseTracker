          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // Simulate update (In real app, call authController.updateName(_nameController.text))
                  Get.back();
                  Get.snackbar(
                    "Success",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            _buildSwitch("Expense Alert", true),
            _buildSwitch("Budget Exceeded", true),
            _buildSwitch("Weekly Report", false),
            _buildSwitch("New Updates", true),
          ],
        ),
      ),
    );
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        // authController.sendPasswordReset(authController.currentUser.value?.email);
                        Get.back();
                        Get.snackbar(
                          "Email Sent",
