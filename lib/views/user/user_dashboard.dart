...
//           // Calculate progress (spent / limit) capped at 1
//           final progress = budget.limit > 0
//               ? (spent / budget.limit).clamp(0.0, 1.0)
//               : 0.0;
//           final spentPercent = progress * 100;
//           final remainingPercent = (1 - progress) * 100;
...
//                       // Small visual progress bar (green = spent, grey = remaining)
//                       ClipRRect(
...
//                             widthFactor: progress, // green width
//                             child: Container(
//                               decoration: BoxDecoration(
//                                 color: AppColors.accent, // green for spent
//                                 borderRadius: BorderRadius.circular(6),
//                               ),
//                             ),
//                           ),
...
//                       // Percent text: spent in green, remaining in grey
//                     ],
//                   ),
//                 ),
